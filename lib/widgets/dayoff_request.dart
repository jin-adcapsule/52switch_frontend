...
// Fetch data
  ...
  final employeeData = await _dayoffService.fetchDayoffInfo(widget.objectId!);
  ...
  void _handleError(Object error) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('에러 발생: ${error.toString()}')),
    );
  }
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<Map<String, dynamic>>(
        future: _fetchDayoffInfo(), // Call the async method
