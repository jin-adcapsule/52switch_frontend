...
class RequestFilterPopup extends StatefulWidget {
  final DateTime startDate;
  final DateTime endDate;
  final Map<String,bool> requestStatusSelection; // Accept multiple selected statuses
  final Function(DateTime, DateTime, Map<String,bool>) onApplyFilters;

  const RequestFilterPopup({
    required this.startDate,
    required this.endDate,
    required this.requestStatusSelection,
    required this.onApplyFilters,
  ...
  @override
  State<RequestFilterPopup> createState() => _RequestFilterPopupState();
}

class _RequestFilterPopupState extends State<RequestFilterPopup> {
