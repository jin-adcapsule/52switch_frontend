              ...
              return Padding(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    String checkInTime =
                        attendance.checkInTime ?? ''; //if null then smpty as ''
                    String checkOutTime = attendance.checkOutTime ??
                        ''; //if null then smpty as ''
                    ...
                    return ListTile(
                      title: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Text(
                                ...
                                style: TextStyle(
                                    fontSize:
                                        14), //fontWeight: FontWeight.bold), // Bold for emphasis
                              ),
                              Text(
                          ...
                          const SizedBox(
                              height: 4), // Add a small gap between rows
...
class OverlappingBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    double position =
        maxExtentBox - scrollOffset; // Adjust position dynamically
