...
class _DayoffScreenState extends State<_DayoffScreen>
  ...
  Map<String, bool> _requestStatusSelection =
      Map<String, bool>.from(defaultRequestStatusSelection); // make mutable Map
  ...
  Future<List<Dayoff>> _fetchDayoffHistory() async {
    try {
      ...
      final dayoffData = await _dayoffService.fetchDayoffHistory(
        ...
        requestStatusList:
            requestStatusList, //null directs get all regardless of status
      );
      return dayoffData;
    } catch (e) {
                ...
                FutureBuilder<List<Dayoff>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (!snapshot.hasData || snapshot.data!.isEmpty) {
                      return SliverToBoxAdapter(
                        child:
                            Center(child: Text('No day-off history available')),
                      );
                    }
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  ListTile(
                                    ...
                                    subtitle: Text(
                                      dayoff
                                          .requestDate, // Display the applyDate here
                                      style: TextStyle(
                                        fontSize: 14,
                                        color: Colors
                                            .grey, // Optional: change the color for better visual hierarchy
                                      ),
                                    ),
                                    trailing: Text(
                                  ...
                                  ListTile(
                                    ...
                                    trailing: SizedBox(
                                      width:
                                          200, // Set a fixed width to limit the trailing text's width
                                      child: Text(
                                        ...
                                        maxLines:
                                            3, // Limit the number of lines (adjust as needed)
...
class _DynamicTextWithTabBarSliverPersistentHeaderDelegate
  ...
  Widget build(
    ...
    double opacity = 1.0 -
        ((shrinkOffset - fadeStart) / (fadeEnd - fadeStart)).clamp(0.0, 1.0);
