...
class SupervisorService {
  ...
  Future<void> answerRequest(String employeeOid, String requestStatus,
      String answerComment, String requestKey) async {
    String mutation = """
      mutation {
  ...
  Future<Map<String, dynamic>> fetchRequestInfo(String employeeOid) async {
    ...
    try {
      ...
      if (employeeResult.hasException) {
        LoggerConfig()
            .logger
            .e('Employee Query Exception: ${employeeResult.exception}');
